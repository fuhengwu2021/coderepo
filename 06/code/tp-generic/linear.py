...
Simplified version inspired by vLLM's linear.py

This module implements:
- ColumnParallelLinear: Splits weight matrix along columns
- RowParallelLinear: Splits weight matrix along rows
"""
import torch
